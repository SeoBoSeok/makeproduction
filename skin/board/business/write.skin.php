...
<section id="bo_w">
    ...
    <div class="bo_w_tit write_div">
        ...
        <label for="wr_1" class="sound_only">소제목</label>
        <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input half_input" size="50" placeholder="소제목">

        <label for="wr_2" class="sound_only">기간</label>
        <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input half_input" size="50" placeholder="기간">
